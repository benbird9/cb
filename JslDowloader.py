...
rdf = jdf.loc[(jdf.btype=='C')&( ~jdf.bond_id.isin(exclude_bonds))&(jdf.price!='100.000'), ['bond_id', 'bond_nm', 'increase_rt', 'price', 'premium_rt', 'ytm_rt', 'year_left']]
...
buy_bonds = top18_defence - exist_bonds
